...
const CartDetails = () => {
  ...
  const { id } = useParams();
  return (
    <div className="grid lg:grid-cols-5 items-center container gap-6 my-10 h-[600px] p-10">
      <div className=" col-span-2 bg-white flex items-center justify-center rounded-lg">
        <img
